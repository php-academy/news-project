...
$news_data = array(
    ...
    array(
        "publish_date" => "2014-10-05 15:25:00",
    ...
    array(
        "publish_date" => "2014-10-15 13:25:00",
    ...
    array(
        "publish_date" => "2014-10-16 13:28:00",
    ...
    array(
        "publish_date" => "2014-11-05 13:40:00",
        "title" => "У самого синего моря 6",
        "text" => "Осень в Новосибирске началась. C небывалого падения 
            цен на путевки. Листья еще не осыпались, а стоимость отдыха 
            в Европе и Юго-Восточной Азии поползла вниз. Отпускников напугали 
            банкротства компаний и нестабильная ситуация в экономике. 
    ...
    array(
        "publish_date" => "2014-11-05 23:25:00",
        "title" => "У самого синего моря 7",
        "text" => "Осень в Новосибирске началась. C небывалого падения 
            цен на путевки. Листья еще не осыпались, а стоимость отдыха 
            в Европе и Юго-Восточной Азии поползла вниз. Отпускников напугали 
            банкротства компаний и нестабильная ситуация в экономике. 
    ...
    array(
        "publish_date" => "2014-12-05 14:25:00",
        "title" => "У самого синего моря 8",
        "text" => "Осень в Новосибирске началась. C небывалого падения 
            цен на путевки. Листья еще не осыпались, а стоимость отдыха 
            в Европе и Юго-Восточной Азии поползла вниз. Отпускников напугали 
            банкротства компаний и нестабильная ситуация в экономике. 
...
foreach( $news_data as $itemId => $arNews ){
    $news[] = new NewsItem($itemId, $arNews['publish_date'], $arNews['title'], $arNews['text']);
}
